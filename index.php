...
<!-- Mirrored from preview.colorlib.com/theme/docmed/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 15 Nov 2020 12:57:11 GMT -->
<head>
    <meta charset="utf-8">
                    ...
                    <div class="col-xl-3 col-lg-3 d-none d-lg-block">
                        <div class="Appointment">
                            <div class="book_btn d-none d-lg-block">
                                <a class="" href="contact.php">Make an Appointment</a>
                            </div>
                        </div>
                    </div>
                    <div class="col-12">
        ...
        <div class="row">
            <div class="col-xl-6 col-lg-6">
                <div class="welcome_thumb">
                    <div class="thumb_1">
                        <img src="img/about/x1.png.pagespeed.ic.gmBngJH7-K.jpg" alt="">
                    </div>
                    <div class="thumb_2">
                        <img src="img/about/x2.png.pagespeed.ic.jYbHUnUZMB.jpg" alt="">
                    </div>
                </div>
            </div>
            <div class="col-xl-6 col-lg-6">
    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-xl-4 col-md-6 col-lg-4">
                <div class="single_department">
                    <div class="department_thumb">
                        <img src="img/department/x1.png.pagespeed.ic.m_KPirB5lS.png" alt="">
                    </div>
            ...
            <div class="col-xl-4 col-md-6 col-lg-4">
                <div class="single_department">
                    <div class="department_thumb">
                        <img src="img/department/x2.png.pagespeed.ic.aiyYKGSIQs.png" alt="">
                    </div>
                    <div class="department_content">
            ...
            <div class="col-xl-4 col-md-6 col-lg-4">
                <div class="single_department">
                    <div class="department_thumb">
                        <img src="img/department/x3.png.pagespeed.ic.yrg3v2UY2Z.png" alt="">
                    </div>
                    <div class="department_content">
            ...
            <div class="col-xl-4 col-md-6 col-lg-4">
                <div class="single_department">
                    <div class="department_thumb">
                        <img src="img/department/x4.png.pagespeed.ic.3-Is68eRQj.png" alt="">
                    </div>
                    <div class="department_content">
            ...
            <div class="col-xl-4 col-md-6 col-lg-4">
                <div class="single_department">
                    <div class="department_thumb">
                        <img src="img/department/x5.png.pagespeed.ic.D9RxHzWrnm.png" alt="">
                    </div>
                    <div class="department_content">
            ...
            <div class="col-xl-4 col-md-6 col-lg-4">
                <div class="single_department">
                    <div class="department_thumb">
                        <img src="img/department/x6.png.pagespeed.ic.I2P02PF2-s.png" alt="">
                    </div>
                    <div class="department_content">
                    ...
                    <ul class="nav" id="myTab" role="tablist">
                        <li class="nav-item">
                            <a class="nav-link active" id="home-tab" data-toggle="tab" href="#home" role="tab"
                               aria-controls="home" aria-selected="true">Excellent Services</a>
                        </li>
                        <li class="nav-item">
                    ...
                    <div class="row align-items-center">
                        ...
                        <div class="col-xl-6 col-md-6">
                            <div class="business_thumb">
                                <img src="img/about/xbusiness.png.pagespeed.ic._YQ3qhtgZM.jpg" alt="">
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="expert_active owl-carousel">
                    ...
                    <div class="single_expert">
                        <div class="expert_thumb">
                            <img src="<?php echo $row['imgUrl']; ?>" class="img-thumbnail">
                        </div>
